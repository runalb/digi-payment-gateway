...
public interface BusinessPaymentChannelConfigRepository
    ...
    Optional<BusinessPaymentChannelConfigEntity> findFirstByBusiness_IdAndIsDeletedFalseOrderByIdAsc(
            Long businessId);
    ...
    Optional<BusinessPaymentChannelConfigEntity> findByIdAndBusiness_IdAndIsDeletedFalse(
            Long id, Long businessId);

    List<BusinessPaymentChannelConfigEntity> findByBusiness_IdAndIsDeletedFalseOrderByIdAsc(
            Long businessId);
}
